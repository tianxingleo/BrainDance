...
import 'recall/result_card.dart';
import 'recall/empty_state.dart';

export 'recall/model_card.dart';
export 'recall/result_card.dart';
export 'recall/empty_state.dart';
...
class _RecallPageState extends State<RecallPage> {
                  ...
                  child: Stack(
                    ...
                    children: [
                      if (!_isLoading && _models.isEmpty)
                        Padding(
                          ...
                          child: EmptyState(
                            isDark: isDark,
                            textColor: textColor,
                            hintTextColor: isDark ? const Color(0xFFCCCCCC) : theme.fontGyColor3,
                            theme: theme,
                            darkCard: darkCard,
                      ...
                      if (_isLoading)
                        ...
                        _buildModelGrid(theme, isDark, textColor),
                    ],
                  ),
                ),
              ],
  ...
  Widget _buildModelGrid(TDThemeData theme, bool isDark, Color textColor) {
