...
DEFAULT_FULL_0P6B = PROJECT_ROOT / "ai_engine" / "finetune_qwen3" / "outputs" / "qwen3_0p6b_full_sft_round1"
DEFAULT_MERGED_1P7B = (
...
CANDIDATES = (
    ...
    CandidateConfig(
        ...
        label="0.6B full SFT",
        backend="hf",
        model_name=str(DEFAULT_FULL_0P6B),
    ),
    CandidateConfig(
    ...
    CandidateConfig(
        ...
        backend="gguf",
        gguf_model_path=str(DEFAULT_Q4_IMATRIX),
    ),
    CandidateConfig(
